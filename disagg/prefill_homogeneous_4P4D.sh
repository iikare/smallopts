...
sudo docker stop vllm-nvidia-gpu-dynamo-prefill-tp4 2>/dev/null
sudo docker rm vllm-nvidia-gpu-dynamo-prefill-tp4 2>/dev/null
...
--group-add video \
--workdir /root \
--name vllm-nvidia-gpu-dynamo-prefill-tp4 \
